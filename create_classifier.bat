...
opencv_traincascade -data data/images/data -vec data/images/samples.vec -bg data/images/bg.dat -numPos 200 -numNeg 100 -numStages 10 -w 20 -h 20 -featureType LBP
